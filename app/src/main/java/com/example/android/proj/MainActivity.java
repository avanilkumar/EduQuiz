...
public class MainActivity extends AppCompatActivity
    ...
    public void updateNavigationMenu() {
        ...
        try {
            ...
            if (str != null) {
                ((TextView) navigationView.getHeaderView(0).findViewById(R.id.teacher)).setText(str);
                mTeacher = str;
            }
            ...
            for (int i = 0; i < cnt; ++i) {
                ...
                if (str != null) {
                    MenuItem item = sub.add(R.id.SubjectGroup,i+1,i,str);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(item.getTitle().toString().equals("Feedback")){
            ...
            i.putExtra(Intent.EXTRA_EMAIL  , new String[]{mFeedback});
            i.putExtra(Intent.EXTRA_SUBJECT, "Feedback");
            i.putExtra(Intent.EXTRA_TEXT   , "Dear "+mTeacher);
            try {
    ...
    public void onOkNxt(View view) {
        Button b = (Button)view;
            ...
            ((TextView)findViewById(R.id.questionScreen).findViewById(R.id.answer)).setText(mCurAnswer);
